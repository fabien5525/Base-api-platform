...
type GreetingGetResponse200 =
    paths["/greetings"]["get"]["responses"]["200"]["content"]["application/json"];
...
export default async function Greeting() {
    ...
    const greetings: Greeting[] = res.ok
        ? ((await res.json()) as GreetingGetResponse200)
        : [];
